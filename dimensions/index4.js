...
function criterionScore2() {
  criterionScoreCalc(["indi-21", "indi-22", "indi-23"], "crit-2");
}

function criterionScore3() {
  criterionScoreCalc(["indi-31", "indi-32", "indi-33", "indi-34"], "crit-3");
}

function criterionScore4() {
  criterionScoreCalc(["indi-41"], "crit-4");
}

function criterionScore5() {
  criterionScoreCalc(["indi-51"], "crit-5");
}
...
function refreshRadioButtons() {
  ...
  document.getElementById("indi-34").innerText="";
